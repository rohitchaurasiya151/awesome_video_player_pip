...
abstract class VideoPlayerPipPlatform extends PlatformInterface {
  ...
  /// Enables auto-enter PiP mode for the specified player ID.
  Future<bool> enableAutoPip(int playerId, {int? width, int? height}) {
    throw UnimplementedError('enableAutoPip() has not been implemented.');
  }

  /// Disables auto-enter PiP mode.
  Future<bool> disableAutoPip() {
