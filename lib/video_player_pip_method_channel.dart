...
class MethodChannelVideoPlayerPip extends VideoPlayerPipPlatform {
  ...
  @override
  Future<bool> enableAutoPip(int playerId, {int? width, int? height}) async {
    try {
  ...
  @override
  Future<bool> disableAutoPip() async {
    try {
      final result = await methodChannel.invokeMethod<bool>('disableAutoPip');
      return result ?? false;
    } on PlatformException catch (e) {
